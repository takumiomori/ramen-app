...
<div class="content_area">
    ...
    <input class="form-control form-control-lg" type="text" placeholder="例）Taro&_tanaka01" name="guest_name" value="{{old('guest_name')}}"><br>
    ...
    <input class="form-control form-control-lg" type="email" placeholder="例）taro@email.com" name="email" value="{{old('email')}}"><br>
